...
- Review Summary 與 Submit Review 成功 resource 必須標記 `pull-request-review.user` 為 nullable，並直接連結 GitHub REST OpenAPI schema；不得將其與其他 REST resource 的 user contract 混用。
