...
- 處理最新 PR review 已明確界定的有界修正：worktree branch occupancy、macOS app relaunch、branch-name fallback、Build macOS Apps upstream local-overlay metadata，以及可長期成立的 repository design principle 回寫。
