...
| 重要欄位 | id、node_id、pull_request_review_id、path、line、side、start_line、start_side、commit_id、original_commit_id、original_position、original_line、original_start_line、body、`user`、`created_at`、`updated_at`、`html_url`、in_reply_to_id |
