...
| AC-NI-020 | Large diff含多file／change | 在Diff／Change Reader使用Arrow，並使用Option+Arrow導覽file | Change只在file內移動；file移動選第一appropriate change；File Navigator的Arrow只移file selection；首尾no-op且reviewed state不變 | §9；Draft 3.6；Baseline navigation；TC-09 |
