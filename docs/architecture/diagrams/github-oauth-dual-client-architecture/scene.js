...
const BOXES = [
  ...
  { id: 'provider', plane: 'integration', band: 'band-integration', x: 670, y: 780, w: 510, h: 126, r: 10, dash: true,
    name: 'OAuthTokenProvider', about: '唯一擁有 OAuth 權杖狀態、版本、更新輪替與單飛復原的未來元件；可在獨立 topic 決定是否符合 async token-acquisition contract。',
    texts: [['bl', 694, 808, 'OAuthTokenProvider'], ['bs', 694, 830, '記憶體快照 · 還原 · 到期判定 · 更新'], ['bs', 694, 846, '輪替 · 版本 · 相同版本單飛'], ['bs', 694, 862, '未來可符合 async GitHubAccessTokenProvider'], ['bn', 694, 884, '不持有 HTTPRequest 或 Apollo 操作']] },
...
const TEXTS = [
  ...
  { s: 'bn', x: 160, y: 1704, t: '已交付 async contract 僅取得權杖；PAT／OAuth 實作、401 復原與 HTTP sender 均延後。' }
];
