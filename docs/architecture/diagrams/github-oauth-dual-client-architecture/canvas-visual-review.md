...
| [canvas-top-1440x900.png](canvas-top-1440x900.png) | 60%；檢視狀態 `#0.598,278,-73` | 標題、層級外組裝根節點、GitHub REST／GraphQL 用戶端，以及 GithubIntegration、已交付的 OAuthTokenProvider、TokenSnapshot、OAuthCredentialStore、OAuthTokenFetcher 的文字與相互依賴。 | 文字可讀；OAuthTokenProvider、TokenSnapshot 與介面的「已交付」狀態，以及 Keychain／HTTP 轉接器延後狀態沒有碰撞，且不將用戶端重試誤畫為已交付。 |
