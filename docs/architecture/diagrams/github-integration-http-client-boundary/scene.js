...
const BOXES = [
  { id:'review-port', plane:'core', band:'band-core', x:200,y:260,w:540,h:68,r:10,dash:true,
    name:'PR Inbox／Reader Port',about:'核心 BC 擁有的資料需求，不認識 GitHub 或 HTTP。',
    texts:[['bl',224,288,'PR Inbox／Reader Port'],['bs',224,310,'不依賴 GitHub 或 HTTP']] },
  { id:'failure-contract', plane:'core', band:'band-core', x:880,y:260,w:540,h:68,r:10,dash:true,
    name:'Core Failure Contract',about:'核心 BC 的語意 failure contract，不含 infrastructure detail。',
    texts:[['bl',904,288,'Core Failure Contract'],['bs',904,310,'不含 infrastructure detail']] },
  ...
  { id:'url-request', plane:'outside', band:'band-outside', x:200,y:1140,w:540,h:68,r:10,
    name:'Foundation URLRequest',about:'Requester 實際建立的 Foundation request surface。',
    texts:[['bl',224,1168,'Foundation URLRequest'],['bs',224,1190,'唯一直接使用的 Foundation type']] },
...
const EDGES = [
  { from:'adapter',to:'review-port',pts:[[470,504],[470,334]],label:{s:'al',x:484,y:420,t:'符合 Port',rot:-90,anchor:'center'} },
  ...
  { from:'client',to:'url-request',pts:[[935,924],[935,1040],[470,1040],[470,1134]],label:{s:'al',x:484,y:1084,t:'Foundation mapping',rot:-90,anchor:'center'} },
