...
const BOXES = [
  ...
  { id:'credential', plane:'outside', band:'band-outside', x:620,y:1290,w:360,h:68,r:10,
    ...
    texts:[['bl',644,1318,'使用者設定 PAT／Keychain'],['bs',644,1340,'Outside；future provider 讀取']] },
...
const EDGES = [
  ...
  { from:'token-provider',to:'request-authorizer',pts:[[744,702],[874,702]],label:{s:'al',x:809,y:690,t:'future token delivery',anchor:'center'} },
  { from:'credential',to:'token-provider',pts:[[800,1284],[800,790],[470,790],[470,760]],label:{s:'al',x:484,y:810,t:'既有 PAT',rot:-90,anchor:'center'} },
  { from:'request-authorizer',to:'request',pts:[[1150,760],[1150,880],[635,880],[635,974]],label:{s:'al',x:649,y:832,t:'Bearer header',rot:-90,anchor:'center'} },
...
const TEXTS = [
  ...
  {s:'tag',x:160,y:146,runs:[{t:'GitHubTokenProvider',fill:planeColor('integration')},{t:' → ',fill:'#4A5462'},{t:'request authorizer',fill:planeColor('integration')},{t:' → ',fill:'#4A5462'},{t:'HTTPRequest',fill:planeColor('package')},{t:' → ',fill:'#4A5462'},{t:'HTTPClient',fill:planeColor('package')}]},
  ...
  {s:'bn',x:160,y:1570,t:'宣告而非實作：future provider／authorizer 屬 GitHub Integration；Keychain 與 PAT 都是 Outside'},
