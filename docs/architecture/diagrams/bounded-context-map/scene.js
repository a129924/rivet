...
const BANDS = [
  ...
  { id: 'band-integration', plane: 'integration', x: 160, y: 1600, w: 1260, h: 200, alpha: 0.5,
    hdr: { x: 184, y: 1630, t: 'GitHub 專用共享整合模組' }, tagr: { x: 1396, y: 1630, t: '非 BC · token contract 已實作 · 對 BC 無知', alpha: 0.6 } },
...
const TEXTS = [
  ...
  { s: 'bn', x: 160, y: 2184, t: 'GitHubIntegration 對所有 BC 無知；僅 token contract 已實作，其他能力延後；RivetHTTPClient 維持通用且不知 GitHub 的基礎' },
