...
const TEXTS = [
  ...
  {s:'sub',x:160,y:118,t:'呼叫端提供已驗證 HTTPURL → HTTP method facade → execute(_:) → Requester → injected Transport／URLSessionTransport → HTTPResponse；不含 Endpoint 組裝'},
  ...
  {s:'bn',x:160,y:1570,t:'延後：Endpoint、status validation、retry、token refresh 與 decode policy'}
];
const SWATCHES = [
