...
const BOXES = [
  { id:'endpoint-domain', plane:'caller', band:'band-caller', x:250,y:260,w:450,h:68,r:10,
    name:'Endpoint／Base URL／Path／Query',about:'呼叫端或 domain layer 組裝 API URL；package 不提供此 API。',
    texts:[['bl',274,288,'Endpoint／Base URL／Path／Query'],['bs',274,310,'呼叫端組裝；不屬於 package']] },
  { id:'validated-url', plane:'caller', band:'band-caller', x:780,y:260,w:450,h:68,r:10,
    name:'Foundation URL',about:'由呼叫端提供，再交由 HTTPURL 做受限 validation。',
    texts:[['bl',804,288,'Foundation URL'],['bs',804,310,'交給 HTTPURL 驗證']] },
  ...
  { id:'url-request', plane:'outside', band:'band-outside', x:200,y:1300,w:540,h:68,r:10,
  ...
  { id:'urlsession', plane:'outside', band:'band-outside', x:880,y:1300,w:540,h:68,r:10,
    name:'Foundation URLSession',about:'可能的 future transport implementation；此切片不實作或依賴它。',
    texts:[['bl',904,1328,'Foundation URLSession'],['bs',904,1350,'本切片未實作']] }
];

const EDGES = [
  { from:'endpoint-domain',to:'validated-url',pts:[[704,294],[774,294]],label:{s:'al',x:739,y:282,t:'組裝 URL',anchor:'center'} },
  { from:'validated-url',to:'http-url',pts:[[1005,334],[1005,400],[335,400],[335,504]],label:{s:'al',x:349,y:444,t:'驗證',rot:-90,anchor:'center'} },
  { from:'http-url',to:'url-error',pts:[[474,554],[494,554]],label:{s:'al',x:484,y:542,t:'typed error',anchor:'center'} },
  { from:'http-url',to:'request',pts:[[335,604],[335,628],[935,628],[935,604]],label:{s:'al',x:635,y:620,t:'已驗證 URL',anchor:'center'} },
  { from:'method-headers',to:'request',pts:[[1064,637],[1080,637],[1080,554],[1094,554]],label:{s:'al',x:1074,y:592,t:'metadata',rot:-90,anchor:'center'} },
  ...
  { from:'requester',to:'url-request',pts:[[1140,894],[1140,1180],[470,1180],[470,1294]],label:{s:'al',x:484,y:1126,t:'Foundation mapping',rot:-90,anchor:'center'} }
];
