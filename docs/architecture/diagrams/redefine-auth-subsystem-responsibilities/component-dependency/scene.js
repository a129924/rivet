...
const EDGES = [
  ...
  { from:'raw-response',to:'auth-requester',pts:[[1152,1020],[1152,930],[1360,930],[1360,610],[972,610],[972,540],[954,540]],label:{s:'al',x:1376,y:720,t:'回傳策略輸入',rot:-90,anchor:'center'} },
