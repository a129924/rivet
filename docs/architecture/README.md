...
- [GitHub OAuth 雙 Client 架構](github-oauth-dual-client.md)：既有 OAuth credential 的 shared token lifecycle、REST／Apollo GraphQL consumer boundary，以及 [責任與依賴 canvas](diagrams/github-oauth-dual-client-architecture/index.html) 與 [token lifecycle](diagrams/github-oauth-dual-client-architecture/token-lifecycle-v3.html)。
