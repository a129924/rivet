...
401 sequence 的唯一 terminal response／caller activation。它們只能遵循 PC-18 → PR-18 → IM-18 → TE-15 →
RV-15 → DL-13 → CH-12 → HC-12，不改變 Model C、original request ownership、deferred preparation、retry
policy、OAuth boundary 或 PR status。
...
CH-11 處理也是已完成的 historical handling。current handling 只可走 PC-18 → PR-18 → IM-18 →
TE-15 → RV-15 → DL-13 → CH-12 → HC-12。
