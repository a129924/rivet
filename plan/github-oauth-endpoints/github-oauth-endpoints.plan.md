...
- public/package API、protocol、configuration、generic registry、GitHub Enterprise、`Package.swift`、docs 與 diagrams。

## ReadOnly

- `README.md`、`docs/**`、`Package.swift`、所有 package target/product declarations。
